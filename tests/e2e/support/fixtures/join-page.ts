...
export class JoinPage {
  ...
  private readonly organizationNameBox: Locator;
  ...
  constructor(
    ...
    this.organizationNameBox = this.page.getByPlaceholder('Team Name');
  ...
  async signUp() {
    ...
    await this.organizationNameBox.fill(this.organizationName);
