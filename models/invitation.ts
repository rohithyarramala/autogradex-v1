...
Bitmap Heap Scan on "Invitation"  (cost=4.16..9.51 rows=1 width=168) (actual time=0.133..0.138 rows=4 loops=1)
  Recheck Cond: ("organizationId" = '12b885f6-dcd9-4b26-b27c-b3c8cf968786'::text)
  Filter: "sentViaEmail"
  Heap Blocks: exact=1
  ->  Bitmap Index Scan on "Invitation_organizationId_email_key"  (cost=0.00..4.16 rows=2 width=0) (actual time=0.096..0.096 rows=4 loops=1)
        Index Cond: ("organizationId" = '12b885f6-dcd9-4b26-b27c-b3c8cf968786'::text)
...
WHERE ("public"."Invitation"."organizationId" = '7974330a-c8ca-4043-9e3c-3f326d1b6973' AND "public"."Invitation"."sentViaEmail" = true) OFFSET 0
*/

/**
  Bitmap Heap Scan on "Invitation"  (cost=4.16..9.51 rows=1 width=168) (actual time=0.019..0.020 rows=3 loops=1)
  Recheck Cond: ("organizationId" = '7974330a-c8ca-4043-9e3c-3f326d1b6973'::text)
  Filter: "sentViaEmail"
  Heap Blocks: exact=1
  ->  Bitmap Index Scan on "Invitation_organizationId_idx"  (cost=0.00..4.16 rows=2 width=0) (actual time=0.006..0.006 rows=4 loops=1)
        Index Cond: ("organizationId" = '7974330a-c8ca-4043-9e3c-3f326d1b6973'::text)
  Planning Time: 0.225 ms
  Execution Time: 0.041 ms
 */
export const getInvitations = async (organizationId: string, sentViaEmail: boolean) => {
